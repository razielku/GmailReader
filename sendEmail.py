...
def SendMessage(service, user_id, message):
  ...
  """
    try:
        ...
        print('An error occurred sending: %s' % error)


def CreateFullMessage(sender, to, subject, message_text, cc, bcc, type=None):
...
def CreateMessage(sender, to, subject, message_text):
  ...
  """
    return CreateFullMessage(sender, to, subject, message_text, None, None)


def createMimessage(sender, to, subject, message_text):
    message = MIMEText(message_text,_subtype='html',_charset='UTF-8')
    message['to'] = to
    message['from'] = sender
    message['subject'] = subject
...
def forward(to, sender, subject, message_text, raw):
